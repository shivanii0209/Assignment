...
public class ProductServiceAspect {
	...
	@Before(value = "execution(* com.zensar.service.ProductServiceImpl.*(..)) and args(productId)")
	public void beforeAdvice(JoinPoint joinPoint, int productId) {
		System.out.println("Before Method: " + joinPoint.getSignature());
	}

	@After(value = "execution(* com.zensar.service.ProductServiceImpl.*(..)) and args(productId, productDto)")
	public void afterAdvice(JoinPoint joinPoint, Object productId, Object productDto) {
		System.out.println("After Method: " + joinPoint.getSignature());
	}

	@Before(value = "execution(* com.zensar.service.ProductServiceImpl.*(..)) and args(productName)")

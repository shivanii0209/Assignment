...
public class CouponController {
	...
	public ResponseEntity<List<CouponDto>> getAllCoupon(
			...
			@RequestParam(value = "sortBy", required = false, defaultValue = "couponCode") String sortingBy,
			@RequestParam(value = "dir", required = false, defaultValue = "DESC") Direction direction) {
		return new ResponseEntity<List<CouponDto>>(
				couponservice.getAllCoupon(pageNumber, pageSize, sortingBy, direction), HttpStatus.OK);
	}
	...
	public Coupon com(@PathVariable String couponCode) {

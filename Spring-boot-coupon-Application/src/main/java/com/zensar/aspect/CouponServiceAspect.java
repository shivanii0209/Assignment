...
public class CouponServiceAspect {
	...
	@Before(value = "execution(* com.zensar.service.CouponServiceImpl.*(..)) and args(couponId)")
	public void beforeAdvice(JoinPoint joinPoint, int couponId) {
		System.out.println("Before Method: "+ joinPoint.getSignature());
	}
	
	@After(value = "execution(* com.zensar.service.CouponServiceImpl.*(..)) and args(couponId, couponDto)")
	public void afterAdvice(JoinPoint joinPoint, Object couponId, Object couponDto) {
		System.out.println("After Method: "+ joinPoint.getSignature());
	}
	
	
	@Before(value = "execution(* com.zensar.service.CouponServiceImpl.*(..)) and args(couponId1, couponId2)")
